...
export type TTextTest4 = z.infer<typeof TextTest4>
	...
	/** text test 5 */
export const TextTest5 =
	z.iso.datetime({ offset: true }).describe("RFC 3339 date-time");
...
export const TextTest8 =
	z.iso.duration().describe("ISO 8601 duration");
export type TTextTest8 = z.infer<typeof TextTest8>


	/** text test 9 */
export const TextTest9 =
	z.uuid().describe("RFC 4122 UUID");
...
export const TextTest11 =
	z.ipv6().describe("IPv6 address");
export type TTextTest11 = z.infer<typeof TextTest11>


	/** text test 12 */
export const TextTest12 =
...
export const ListTest3 =
	z.array(
		z.string().optional()
	).describe("a list of optional text");
...
export const ListTest4 =
	z.array(
		z.string().nullable()
	).describe("a list of nullable text");
export type TListTest4 = z.infer<typeof ListTest4>


	/** list test 5 */
export const ListTest5 =
	z.array(
		z.string().nullish()
	).describe("a list of nullish text");
...
export const OneOfTest4Option0 =
	z.object({
		bar :
			z.number(),
		foo :
...
export const OneOfTest4Option1 =
	z.object({
		foo :
			z.string(),
	});
export type TOneOfTest4Option1 = z.infer<typeof OneOfTest4Option1>
	...
	/** oneOf test 4 */
export const OneOfTest4 =
	z.union([
		OneOfTest4Option0,
		OneOfTest4Option1
	]).describe("extended record before base record");
export type TOneOfTest4 = z.infer<typeof OneOfTest4>


export const OneOfTest5Option0 =
	z.object({
		foo :
			z.string(),
	});
...
export const OneOfTest5Option1 =
	z.object({
		bar :
			z.number(),
		foo :
...
export type TOneOfTest5Option1 = z.infer<typeof OneOfTest5Option1>
	...
	/** oneOf test 5 */
export const OneOfTest5 =
	z.union([
		OneOfTest5Option0,
		OneOfTest5Option1
	]).describe("base record before extended record");
export type TOneOfTest5 = z.infer<typeof OneOfTest5>


	/** oneOf test 6 */
export const OneOfTest6 =
	z.union([
		z.string(),
		z.number().int().nonnegative()
	]).describe("optional text or natural").optional();
export type TOneOfTest6 = z.infer<typeof OneOfTest6>


	/** oneOf test 7 */
export const OneOfTest7 =
	z.union([
		z.string(),
		z.number().int().nonnegative()
	]).describe("nullable text or optional natural").nullish();
