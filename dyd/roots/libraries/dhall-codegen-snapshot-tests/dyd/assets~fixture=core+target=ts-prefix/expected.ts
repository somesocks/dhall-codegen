...
/** text test 6 */
export type TTextTest6 =
	/** ISO 8601 calendar date */
	string;


/** text test 7 */
export type TTextTest7 =
	/** ISO 8601 local time */
	string;


/** text test 8 */
export type TTextTest8 =
	/** ISO 8601 duration */
	string;
