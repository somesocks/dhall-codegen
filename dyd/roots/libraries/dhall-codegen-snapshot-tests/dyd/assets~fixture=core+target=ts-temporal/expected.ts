...
export type AnyTest0 = unknown;
 ...
 /** any test 1 */
export type AnyTest1 = any;

 /** any test 2 */
export type AnyTest2 = /** comment */ unknown;

 /** any test 3 */
export type AnyTest3 = /** multi-line comment */ unknown;

 /** boolean test 0 */
export type BooleanTest0 = boolean;

 /** boolean test 1 */
export type BooleanTest1 = /** comment */ boolean;

 /** boolean test 2 */
export type BooleanTest2 = /** multi-line comment */ boolean;

 /** number test 0 */
export type NumberTest0 = number;

 /** number test 1 */
export type NumberTest1 = /** number */ number;

 /** number test 2 */
export type NumberTest2 = /** natural */ number;

 /** number test 3 */
export type NumberTest3 = /** integer */ number;

 /** number test 4 */
export type NumberTest4 = /** decimal */ number;

 /** text test 0 */
export type TextTest0 = string;

 /** text test 1 */
export type TextTest1 = /** text */ string;

 /** text test 2 */
export type TextTest2 = /** email */ string;

 /** text test 3 */
export type TextTest3 = /** url */ string;

 /** text test 4 */
export type TextTest4 = /** text literal */ "foo";
...
export type TextTest13 = /** RFC 4648 Base64url */ string;
 ...
 /** text test 14 */
export type TextTest14 = /** E.164 telephone number */ string;

 /** time test 0 */
export type TimeTest0 = Temporal.Instant;
...
export type TimeTest2 = /** calendar date */ Temporal.PlainDate;
 ...
 /** time test 3 */
export type TimeTest3 = /** local time */ Temporal.PlainTime;

 /** time test 4 */
export type TimeTest4 = /** ISO 8601 duration */ Temporal.Duration;
...
export type OptionalTest1Value = { foo : string; };
 ...
 /** optional test 1 */
export type OptionalTest1 = ( OptionalTest1Value | undefined );
...
export type SetTest0 = /** a set */ Set< string >;
 ...
 /** set test 1 */
export type SetTest1 = /** a set-like list */ Array< string >;
...
export type SetTest3Values = /** a record inside a set */ { foo : string; };
 ...
 /** set test 3 */
export type SetTest3 = /** a set */ Set< /** a record inside a set */ SetTest3Values >;

 /** map test 0 */
export type MapTest0 = /** a map */ Map< string, string >;

 /** map test 1 */
export type MapTest1 = /** a map-like record */ Record< string, string >;
...
export type OneOfTest2Option2 = { bar : number; foo : string; };
 ...
 /** oneOf test 2 */
export type OneOfTest2 = /** number or string or record */ ( string | number | OneOfTest2Option2 );
...
export type AllOfTest0Option1 = { foo : string; };
 ...
 /** allOf test 0 */
export type AllOfTest0 = /** all of two records */ ( AllOfTest0Option0 & AllOfTest0Option1 );

 /** tuple test 0 */
export type TupleTest0 = [ string, number ];

 /** tuple test 1 */
export type TupleTest1 = /** a tuple */ [ string, number ];

 /** tuple test 2 */
export type TupleTest2 = /** a tuple */ [ string, /** a tuple in a tuple */ [ string, number ] ];

 /** record test 0 */
export type RecordTest0 = { age : number; deceased : boolean; name : string; };
...
export type RecordTest2Contact = { email ?: string; phone ?: string; };
 ...
 /** record test 2 */
export type RecordTest2 = /** a record with an embedded record */ { age : number; contact : RecordTest2Contact; deceased : boolean; name : string; };

 /** record test 3 */
export type RecordTest3 = /** a record with optional props */ { name : string; age ?: number; deceased ?: boolean; };
...
export type FunctionTest0 = ( ) =>  void;
 ...
 /** function test 1 */
export type FunctionTest1 = ( ) =>  Promise<void>;

 /** function test 2 */
export type FunctionTest2 = ( x0 : boolean ) =>  void;

 /** function test 3 */
export type FunctionTest3 = ( x0 : boolean ) =>  Promise<void>;

 /** function test 4 */
export type FunctionTest4 = ( x0 : boolean, x1 : number, x2 : string ) =>  void;

 /** function test 5 */
export type FunctionTest5 = ( x0 : boolean, x1 : number, x2 : string ) =>  Promise<void>;

 /** function test 6 */
export type FunctionTest6 = ( ) =>  void;

 /** function test 7 */
export type FunctionTest7 = ( ) =>  Promise<void>;

 /** function test 8 */
export type FunctionTest8 = ( ) =>  boolean;

 /** function test 9 */
export type FunctionTest9 = ( ) =>  Promise< boolean >;

 /** function test 10 */
export type FunctionTest10 = ( ) =>  [ boolean, number, string ];

 /** function test 11 */
export type FunctionTest11 = ( ) =>  Promise<[ boolean, number, string ]>;

 /** function test 12 */
export type FunctionTest12 = ( x0 : number, x1 : string ) =>  [ string, boolean ];
...
export type FunctionTest15Output1 = { bar : string; foo : number; };
 ...
 /** function test 15 */
export type FunctionTest15 = ( x0 : FunctionTest15Input0, x1 : FunctionTest15Input1 ) =>  Promise<[ FunctionTest15Output0, FunctionTest15Output1 ]>;